...
const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/appointments", label: "Appointments", icon: icon("M8 2v4M16 2v4M3 10h18M5 4h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2z") },
  { href: "/patients", label: "Patients", icon: icon("M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2M9 11a4 4 0 1 0 0-8 4 4 0 0 0 0 8zM22 21v-2a4 4 0 0 0-3-3.9") },
    ...
    <div className="min-h-screen flex">
      ...
      <aside className="hidden lg:flex w-60 shrink-0 flex-col border-r border-line bg-surface">
        <div className="px-5 py-5 border-b border-line">
          <p className="text-sm font-semibold text-ink">Clinic Receptionist</p>
